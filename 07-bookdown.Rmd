...
## Exercice 6
  ...
  - Attention : pour que cela fonctionne bien, il faut placer ces .Rmd à assembler, les images, le _bookdown.yml et le _output.yml dans un même sous dossier et modifier votre dossier de travail en conséquence. Ce sous-dossier ne doit pas contenir d'autre .Rmd que ceux à assembler dans le book
