...
L'entête yaml du rapport se trouve dans le fichier `index.Rmd`^[Attention, si le projet contient plusieurs fichiers Rmd présentant une entête yaml, la dernière écrase la ou les précédentes.].
...
Notamment, le package gouvdown propose un template bookdown `gitbook_gouv`, dérivé du format gitbook, accessible depuis le menu des nouveaux projets R, pour des book conforme à la marque Etat. 
