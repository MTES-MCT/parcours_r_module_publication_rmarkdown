...
## Exercice 6
  ...
  - Repartir du .Rmd de l'exercice 4 (celui au format HTML)
  - Découper ce fichier en 3 .Rmd distincts, un pour l'image d'en-tête et le premier texte, un pour le premier chapitre, un pour le second chapitre
  - Créer un book pour assembler ces 3 chapitres en un seul document
  - Attention : pour que cela fonctionne bien, il faut placer ces .Rmd à assembler, les images, le _bookdoawn.yml et le _output.yml dans un même sous dossier et modifier votre dossier de travail en conséquence. Ce sous-dossier ne doit pas contenir d'autre .Rmd que ceux à assembler dans le book
