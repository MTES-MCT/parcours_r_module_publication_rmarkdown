...
#### Structurer le document avec des titres hiérarchisés et inrégrer une table des matières
...
````
Conseils pour rédiger le texte alternatif : décrire le message principal et les les tendances importantes.  
...
En repartant du fichier .Rmd de l'exercice précédent :
  ...
  - Générer le document 
  - Dupliquer le fichier .Rmd (on s'en resservira plus tard) et modifier ce duplicata pour qu'il génère un document PDF au lieu du HTML. Il est important de vérifier la compatibilité des éléments définis avec ce nouveau format.  
