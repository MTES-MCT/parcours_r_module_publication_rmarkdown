...
## Pourquoi se limiter à R ?

En réalité, les chunks d'un document Quarto peuvent être dans d'autres langages grâce au package knitr.
...
Pour utiliser un autre langage, il suffit de changer l'appel entre accolades en haut du chunk, par exemple :

```{python}

```

Pour du SQL il faut impérativement ajouter un paramètre de connexion à l'aide d'une variable préalablement fixée dans un chunk R (qu'on mettra en "include = FALSE" pour un cas réel) :
