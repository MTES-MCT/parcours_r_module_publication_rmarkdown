...
![](assets/img/creerprojet4.png){#id .class width=500}
...
![](assets/img/creerprojet1.png){#id .class width=500}

- Cliquez sur *New Directory*.

![](assets/img/creerprojet2.png){#id .class width=500}
...
![](assets/img/creerprojet3.png){#id .class width=500}
