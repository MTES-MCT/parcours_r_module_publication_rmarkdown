...
`...pour approfondir^[on ajoute une note de bas de page]` rend : 
...pour approfondir^[on ajoute une note de bas de page].
...
Pour cela on peut utiliser le raccourci clavier [Ctrl + Shift + C]{.kbd} ou la commande dans le menu "Code".
