...
Un fichier R Markdown ressemble à ça : 

```{r create-xaringan, include=FALSE}
rmarkdown::render(input = "assets/slides/str_fic_rmd.Rmd", output_dir = "assets/slides/")
```

```{r embed-xaringan, echo=FALSE}
xaringanExtra::embed_xaringan(url = "assets/slides/str_fic_rmd.html", ratio = "16:9")
```
