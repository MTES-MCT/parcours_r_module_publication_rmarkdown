...
::: {}
Le [livre de recettes Rmarkdown](https://bookdown.org/yihui/rmarkdown-cookbook/) prolonge le guide Rmarkdown. C'est un florilège d'exemples pratiques répondant à des besoins exprimés sur des forums.
...
Une fois le fichier .Rmd complété et enregistré, vous pouvez visualiser la table des matières en cliquant sur l'icône ![](assets/img/icone_table_matiere.png) en haut à droite. Vous pouvez aussi prévisualiser le document en sortie en cliquant sur le bouton "Visual" qui donne accès au mode visuel de l'éditeur de fichier.
...
`...pour approfondir^[on ajoute une note de bas de page]` rend '...pour approfondir[^03-le_fichier_rmarkdown-1]'.

[^03-le_fichier_rmarkdown-1]: on ajoute une note de bas de page
