...
Pour faire des **liens internes**, on peut utiliser la même syntaxe : 

| texte saisi                                         | résultat après knit |
| --------------------------------------------------- | ------------------- |
| `[Aller au § 'Commentaires'](#commentaires)` | [Aller au § 'Commentaires'](#commentaires) |
...
Les titres contiennent tous une ancre html mobilisable avec `#`. Pour récupérer son nom exact on peut compiler le document et l'y récupérer.  

On peut par ailleurs forcer la création d'ancre sur une ligne de texte en apposant `{#nom_ancre}` à cette dernière.
