...
Vous pouvez intégrer des cartes leaflet, des cartes et graphiques ggiraph, des graphiques plotly, des datatables et bien d'autres qui offrent des possibilités d'animations au survol, d'infobulles, de zoom etc.
