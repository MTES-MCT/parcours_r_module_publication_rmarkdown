...
2.  toujours dans votre projet RStudio, lancer `usethis::use_git()` dans la console pour activer le traking de git pour ce projet. RStudio vous propose d'enregistrer une version, sorte de premier point de restauration, de votre projet :![](assets/img/gitlab2.png)
...
5.  Intégration continue Par convention ce qui se situe dans le dossier public, peut être publié automatiquement par gitlab sur gitlab-pages si l'intégration continue est active.\
