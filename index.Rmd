...
## Exemples de productions avec R Markdown {.unnumbered}
...
- Des tableaux de bord interactifs en combinant avec des widgets html ou des éléments produits par le package shiny. [Exemple](https://testing-apps.shinyapps.io/flexdashboard-highcharter/)
- Des pages web statiques comme des [supports de formation](https://mtes-mct.github.io/parcours_r_module_analyse_spatiale/)
- Des publications paramétrables faciles à mettre à jour
  - [Publications RPLS régionales 2025](https://dreal.statistiques.developpement-durable.gouv.fr/parc_social/2025/)\
  ...
  - [Constructions neuves dans les Hauts-de-France](https://www.hauts-de-france.developpement-durable.gouv.fr/static/logements/sitadel-tableau-de-bord-logements-hauts-de-france.html#cartesfrance)
- Et même des livres :

[![R for data science](assets/img/cover_R_for_datascience.jpg){.centered width="30%"}](https://r4ds.hadley.nz/)

- divers autres formats comme des blogs, des sites web, du epub, des diaporamas, etc.

```{r, warning=FALSE, echo=FALSE}
library(savoirfR) #on active savoir faire pour y récupérer les consignes des exercices
```
