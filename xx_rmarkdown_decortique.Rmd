...
-   `toc_depth: 2` permet de définir le niveau de titre le plus bas à mettre dans le sommaire. L'ensemble des options est listé page 5 du [document de référence Rmarkdown](https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf)
...
-   `include = TRUE` : Le code contenu dans le chunk est éxecuté sans que soient affichés ni le chunk ni son résultat.
...
````
*comment afficher les côtes pour r numero?*
...
-   Partir du fichier .Rmd de l'exercice précédent
-   Ajouter un chunk, qui sera traité mais non affiché dans le document final *quel traitement de données?*
-   Ajouter un chunk, qui sera traité et affiché dans le document final *quel output*
-   Générer le document 
...
mises en commentaires indentation auto?
